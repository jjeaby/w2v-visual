...
if __name__ == '__main__':
    ...
    word2vec_model = ut.word2vec(word2vec_data)


    print('word2vec_model similar list')
    ...
    similar = word2vec_model.most_similar(positive=['삼성', '제로페이'], topn=10)
    print(similar)

    print(similar)

    ut.plt_show(word2vec_model, img_name='word2vec.png')
    ...
    ut.visualize(word2vec_model, "./word2vec_log")
